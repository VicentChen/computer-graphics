...
int main(int argc, char *argv[]) {
  ...
  // shaders
  Shader shader("gamma-correction.vs", "gamma-correction.fs");
  ...
  while(!glfwWindowShouldClose(window)) {
    ...
    shader.setVec3("light_pos[0]", light_pos[0]);
    shader.setVec3("light_pos[1]", light_pos[1]);
    shader.setVec3("light_pos[2]", light_pos[2]);
    shader.setVec3("light_pos[3]", light_pos[3]);

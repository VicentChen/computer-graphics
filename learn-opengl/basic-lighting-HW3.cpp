...
int main(int argc, char const *argv[]) {
  ...
  Shader cube_shader("basic-lighting-HW3.vs", "basic-lighting-HW3.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    cube_shader.setVec3("light_pos", vec3(view * vec4(light_pos, 1.0f)));
    cube_shader.setVec3("view_pos", vec3(0.0f));

...
int main(int argc, char const *argv[]) {
  ...
  Shader cube_shader("materials.vs", "materials.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    cube_shader.setVec3("light.ambient", ambient_color);
    cube_shader.setVec3("light.diffuse", diffuse_color); // darken the light a bit to fit the scene

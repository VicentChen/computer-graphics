...
int main(int argc, char const *argv[]) {
  ...
  Shader cube_shader("light-casters.vs", "light-casters.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      cube_shader.setFloat("light.cut_off", cos(radians(12.5f)));
      cube_shader.setFloat("light.outer_cut_off", cos(radians(17.5f)));

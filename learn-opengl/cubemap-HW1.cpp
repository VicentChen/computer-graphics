...
int main(int argc, char* argv[]) {
  ...
  // shader
  Shader shader("cubemap-HW1.vs", "cubemap-HW1.fs");
  Shader skybox_shader("skybox-HW1.vs", "skybox-HW1.fs");
  ...
  unsigned int cube_texture = load_texture("pic/container.jpg");
  shader.use();
  shader.setInt("texture_1", 3);

  unsigned int skybox_texture = load_cubemap(faces);
  skybox_shader.use();
  skybox_shader.setInt("texture_1", 0);

  Model ourModel("mod/nanosuit_reflection/nanosuit.obj", aiTextureType_AMBIENT);
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    skybox_shader.use();
    skybox_shader.setMat4("view", mat4(mat3(camera.GetViewMatrix())));
